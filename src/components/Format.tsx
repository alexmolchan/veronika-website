...
const icons: Record<string, JSX.Element> = {
  ...
  file: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-6 h-6"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/></svg>,
}

export default function Format({ content }: { content: any }) {
  return (
    <section id="format" className="py-28 px-[5%] bg-off-white">
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-20 items-center max-w-5xl mx-auto">
        <div>
          <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-grass mb-6 font-semibold">
            <span>+</span> Формат работы
          </div>
          <h2 className="font-serif text-3xl lg:text-4xl mb-8">Как проходит работа</h2>
        ...
        <div className="order-first lg:order-last">
          <img src="/images/format.jpg" alt="Формат работы" className="w-full h-[400px] lg:h-[500px] object-cover" />
        </div>
      </div>
    </section>
  )
